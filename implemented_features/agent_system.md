...
## Vue d'ensemble
Le cœur de l'automatisation d'Econ Graph est un pipeline séquentiel d'agents spécialisés, orchestré par **LangGraph**. Cette architecture permet de décomposer la tâche complexe de "création de modèle économique" en sous-tâches gérables et vérifiables.
